...
const app = express();
// Point this to the folder where index.html and pdf-viewer.js live
app.use(express.static(path.join(process.cwd(), 'scribe-ui', 'basic-viewer')));
app.use(express.json({ limit: '100mb' }));
app.use(fileUpload());
// 1. Root route to confirm server is up
app.get('/', (req, res) => {
    // Send the index.html located in the scribe-ui/basic-viewer directory
    const indexPath = path.join(process.cwd(), 'scribe-ui', 'basic-viewer', 'index.html');
